...
# 利用方法
  1. トップページヘッダー部より新規登録を行う。
  2. 新規投稿でスポットの登録を行うことができる。
  3. トップページ中央部より登録されているスポットを押すと詳細ページへ遷移する。「スポット一覧」を押すと一覧が表示される。タイトルを押すと詳細ページへ遷移する。
  4. 詳細ページよりログイン状態であればチャットルームへ遷移できる。
  5. チャットルームでの情報交換ができる。
